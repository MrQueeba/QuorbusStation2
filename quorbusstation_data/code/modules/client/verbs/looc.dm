...
/client/verb/looc(msg as text)
	...
	for(var/client/target in GLOB.clients)
		...
		to_chat(target, span_looc(span_bold("<span class='prefix'><font color='[LOOC_SPAN_COLOR]'>LOOC[prefix]: </font></span><font color='[LOOC_SPAN_COLOR]'><EM>[display_admin ? "[display_admin]" : "[display_name]"]:</EM> [message_contents]</span></font>")))
